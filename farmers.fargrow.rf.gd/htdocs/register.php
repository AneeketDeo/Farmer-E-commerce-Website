    ...
    <div class="navbar-collapse">
      <ul class="main-navigation">
       ...
       <!--<li><a href="category.php"   class="parent"  >Product</a> </li>-->
        ...
        <li><a href="http://farmers.fargrow.rf.gd/" class="parent"> Sell My Product</a>
      ...
      <form class="form-horizontal" enctype="multipart/form-data" method="post" action="register.php">
        <fieldset id="account">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="tel" class="form-control" id="input-telephone" placeholder="Mobile No." value="<?php echo $MobNo; ?>" name="MobNo" required>
            </div>
          </div>
          <div class="form-group required">
            <label for="input-email" class="col-sm-2 control-label">E-Mail</label>
            <div class="col-sm-10">
              <input type="email" class="form-control" id="input-email" placeholder="E-Mail" value="<?php echo $email; ?>" name="email" >
            </div>
          </div>
        ...
        <fieldset id="address">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="input-address-1" placeholder="Address 1" value="" name="Addr1" required>
            </div>
          </div>
          <div class="form-group">
            <label for="input-address-2" class="col-sm-2 control-label">Address 2*</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" id="input-address-2" placeholder="Address 2" value="" name="Addr2" required>
            </div>
          </div>
          <div class="form-group required">
            <label for="input-city" class="col-sm-2 control-label">City*</label>
            <div class="col-sm-10">
             <select class="form-control" id="input-zone" name="zone_id" required>
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <select class="form-control" id="input-country" value="" name="country_id" required>
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <select class="form-control" id="input-zone" value="" name="zone_id_2" required>
        ...
        <fieldset>
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="password" class="form-control" id="input-password" placeholder="Password" value="" name="Password_1" required>
            </div>
          </div>
          <div class="form-group required">
            <label for="input-confirm" class="col-sm-2 control-label">Password Confirm*</label>
            <div class="col-sm-10">
              <input type="password" class="form-control" id="input-confirm" placeholder="Password Confirm" value="" name="Password_2" required>
            </div>
          </div>
        </fieldset>
        ...
        <div class="buttons">
          <!--<div class="pull-right">I have read and agree to the <a class="agree" href="#"><b>Privacy Policy</b></a>
            ...
            &nbsp;
            <div class="g-recaptcha" data-sitekey="6Lcgw_gaAAAAANV3cIfy-OinG104eTEwvLpmNJaN"></div>
            <br>
            <input type="submit" class="btn btn-primary" value="Register" name="reg_user">
          </div>
        </div>
      </form>
    </div>
...
function CheckCaptcha($userResponse) {
        $fields_string = '';
        $fields = array(
            'secret' => '6Lcgw_gaAAAAAFCCwqubS1meQGdNjP6A4vO-st7l',
    ...
    <div class="row">
      <div class="col-sm-3 footer-block">
        ...
        <ul class="list-unstyled ul-wrapper">
          ...
          <li><a href="http://fargrow.rf.gd/about-us.php">About Us</a></li>
      ...
      <div class="col-sm-3 footer-block">
        ...
        <ul class="list-unstyled ul-wrapper">
          <li><a href="http://fargrow.rf.gd/contact.php">Contact Us</a></li>
          <li><a href="profile.php">My Account</a></li>
  ...
  <div class="footer-bottom">
    <div id="bottom-footer">
      <ul class="footer-link">
        <li><a href="http://fargrow.rf.gd/index.php">Home</a></li>
        <li><a href="http://fargrow.rf.gd/category.php">Product</a></li>
        <li><a href="http://farmers.fargrow.rf.gd/">Sell My Product</a></li>
        <li><a href="http://fargrow.rf.gd/about-us.php">About Us</a></li>
        <li><a href="http://fargrow.rf.gd/contact.php">Contact Us</a></li>
      </ul>
      <div class="copyright"> Copyright - Created by Fargrow &copy; 2021 </a></div>
    </div>
  </div>
