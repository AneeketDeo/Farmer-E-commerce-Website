...
<div class="parallax-container">
  ...
  <div class="container">
    <ul id="testimonial" class="row owl-carousel product-slider">
      ...
      <li class="item">
        <div class="panel-default">
          <div class="testimonial-image"><img src="image/test2.png" alt="#"></div>
          <div class="testimonial-name">
            <h2>Shubham Surwase</h2>
          </div>
          <div class="testimonial-designation">
            <p>Web Developer</p>
      ...
      <li class="item">
        <div class="panel-default">
          <div class="testimonial-image"><img src="image/test3.png" alt="#"></div>
          <div class="testimonial-name">
            <h2>Smitesh Kamble</h2>
          </div>
          <div class="testimonial-designation">
            <p>Web developer</p>
          </div>
       ...
       <li class="item">
        <div class="panel-default">
          <div class="testimonial-image"><img src="image/test4.png" alt="#"></div>
          <div class="testimonial-name">
            <h2>Nilesh Dongare</h2>
          </div>
          <div class="testimonial-designation">
            <p>Web developer</p>
          </div>
