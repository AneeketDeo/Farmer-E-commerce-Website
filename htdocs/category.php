                               ...
                               <div class="product-layout product-list col-xs-12">
                                <div class="product-thumb">
                                   ...
                                   <ul class="button-group list-btn">       
                                        <li>
                                        <a href="buynow.php"><button type="button" class="addtocart-btn" data-toggle="tooltip" data-placement="top" title="Buy Now"   > Buy Now  <i class="fa fa-shopping-bag"></i></button></a>
                                        </li>
                                    </ul> 
                                </div>
                                </div>
