...
<div class="breadcrumb parallax-container">
  ...
  <ul>
    ...
    <li><a href="cart.php">Sell Your Product</a></li>
  </ul>
</div>
<div class="container">
  <div class="row">
    ...
    <form method="post" enctype="multipart/form-data" >
      <!--<div class="row">
          ...
          <button type="submit" value="Upload" name="insert" id="insert" data-loading-text="Loading..." class="btn btn-primary" >-->
           ...
           <a href="http://farmers.fargrow.rf.gd/"> <input type="button" value="Sell Your Products" name="myproduct" id="myproduct" data-loading-text="Loading..." class="btn btn-primary" ></a>
