...
<div class="container">
  ...
  <div class="row team">
      ...
      <div class="text-box">
        ...
        <div class="social-holder">
          <ul class="social">
            ...
            <li><a href="https://instagram.com/aneeket_deo" class="pinterest"><i class="fa fa-instagram"></i></a></li>
          </ul>
        </div>
      </div>
    </div>
    <div class="col-md-3 col-sm-3 col-xs-6 team3 ">
      <div class="img-block"> <img alt="#" src="image/team2.jpg" class="img-responsive"> </div>
      <div class="text-box">
        <h3 class="name">Shubham Surwase</h3>
        <div class="deg">CEO Founder </div>
        <p>Web Developer</p>
        <div class="social-holder">
          <ul class="social">
            <li><a href="#" class="facebook"><i class="fa fa-facebook"></i></a></li>
            <li><a href="#" class="twitter"><i class="fa fa-twitter"></i></a></li>
            <li><a href="https://instagram.com/shubham.93_?utm_medium=copy_link" class="pinterest"><i class="fa fa-instagram"></i></a></li>
          </ul>
        </div>
      </div>
    </div>
     <div class="col-md-3 col-sm-3 col-xs-6 team3 ">
      <div class="img-block"> <img alt="#" src="image/team2.jpg" class="img-responsive"> </div>
      <div class="text-box">
        <h3 class="name">Nilesh Dongare</h3>
        <div class="deg">CEO Founder </div>
        <p>Web Developer</p>
        <div class="social-holder">
          <ul class="social">
            <li><a href="#" class="facebook"><i class="fa fa-facebook"></i></a></li>
            <li><a href="#" class="twitter"><i class="fa fa-twitter"></i></a></li>
            <li><a href="https://instagram.com/innocent_boy_nillu?utm_medium=copy_link" class="pinterest"><i class="fa fa-instagram"></i></a></li>
          </ul>
        </div>
      </div>
    </div>
     <div class="col-md-3 col-sm-3 col-xs-6 team3 ">
      <div class="img-block"> <img alt="#" src="image/team2.jpg" class="img-responsive"> </div>
      <div class="text-box">
        <h3 class="name">Smitesh Kamble</h3>
        <div class="deg">CEO Founder </div>
        <p>Web Developer</p>
        <div class="social-holder">
          <ul class="social">
            <li><a href="#" class="facebook"><i class="fa fa-facebook"></i></a></li>
            <li><a href="#" class="twitter"><i class="fa fa-twitter"></i></a></li>
            <li><a href="https://instagram.com/_smitesh_2772_?utm_medium=copy_link" class="pinterest"><i class="fa fa-instagram"></i></a></li>
          </ul>
        </div>
      </div>
    </div>
