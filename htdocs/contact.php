...
<div class="container">
  <div class="row">
    <div class="col-md-offset-1 col-md-10">
      ...
      <p class="text-center contact-desc">Trying to reach out? <br>
      Here is our contact information. Feel free to ask or answer anything.</p>
    </div>
  </div>
  <div class="row">
    <div class="col-sm-4">
      <div class="complaint">
        <h2 class="tf">Mob</h2>
        <div class="call-info">9922425315 / 7498251990</div>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="email">
        <h2 class="tf">Mail</h2>
        <div class="email-info">infoservices@fargrow.com</div>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="time">
